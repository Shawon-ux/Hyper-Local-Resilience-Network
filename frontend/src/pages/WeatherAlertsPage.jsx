...
import { AlertTriangle, Clock, Info, MapPin, RefreshCw } from 'lucide-react';
...
const WeatherAlertsPage = () => {
  ...
  return (
    <Layout
      ...
      subtitle="Stay informed about potential crises and weather emergencies in your area"
    >
            ...
            <div className="flex items-center gap-3 text-slate-900">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Fetch alerts for your current area or by coordinates.
                </p>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3 text-slate-900">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    Alerts are fetched from public disaster feeds and shown here for your selected locality.
                  </p>
                </div>
              </div>
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 text-slate-900">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Real-time weather and disaster warnings for the selected location.
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3 text-slate-900">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">
                Use the information here to stay ready for possible evacuation, sheltering, or community response.
                If alerts are active, check your local emergency resources and stay tuned for updates.
              </p>
            </div>
          </div>
        </section>
